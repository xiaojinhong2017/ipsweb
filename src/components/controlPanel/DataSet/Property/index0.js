...
class DataSet extends Component {
  ...
  confirm() {
    window.vtk.toolapis.openDicomSeries(this.select.value);
    this.props.hideData();
  }
  render() {
    return (
      ...
      >
        ...
        {
          (this.props.dataNodeList.length === 0) &&
            ...
            <div className='popupContent' >
              <div className='changeDataLineLeft' >
                  ...
                  <select ref={(c) => { this.select = c; }} onTouchEnd={this.inputTouch} defaultValue={0} >
                    {
                      this.props.dataNodeList.map((node, index) =>
...
DataSet.propTypes = {
  ...
  dataNodeList: ReactPropTypes.array,
  properties: ReactPropTypes.object,
  changeData: ReactPropTypes.func,
  hideData: ReactPropTypes.func,
  getNodeProperties: ReactPropTypes.func,
 };
